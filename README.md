...
**Databases:** MySQL  
**Testing:** Manual Testing, API Testing (Postman), Basic Automation (Selenium)  
...
[![Selenium](https://img.shields.io/badge/Selenium-Automation-lightblue)](https://www.selenium.dev/)  
